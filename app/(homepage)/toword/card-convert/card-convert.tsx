...
export const CardConvert = () => {
    ...
    const [work, setWorker] = useState<any>(null);
    ...
    const handleCancel = async () => {
        console.log(jobId);
        (await Tesseract.createWorker()).terminate();
        setText("");
        setPdfFile(null);
    }
    return (
        <div className='space-y-10'>
            ...
            {
                pdfFile ? <CardProcess onClose={handleCancel} fileName={filename.length > 20 ? filename.slice(0, 10) + ' ...' : filename} size={sizeFile(pdfFile)} /> : <Card className='p-6 flex flex-col justify-center items-center w-[600px] m-auto'>
                    ...
                    <CardContent>
                        <div className='grid justify-center'>
                            ...
                            <Button className='py-2 w-48' onClick={handleOpenFIleInput}>Select File</Button>
                        </div>
                    </CardContent>
                </Card>
            }
