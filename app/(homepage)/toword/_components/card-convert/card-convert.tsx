    ...
    return (
        <div className='space-y-10'>
            <div className='space-y-2 pt-28'>
                ...
                <p className='w-[60%] max-lg:w-[90%] max-md:w-[99%] m-auto text-center'>Text recognition without software installation or download. This converter allows you to convert pdf to the Microsoft Word formats DOC and DOCX.</p>
            </div>
            {
                pdfFile ? (
                    <div>
