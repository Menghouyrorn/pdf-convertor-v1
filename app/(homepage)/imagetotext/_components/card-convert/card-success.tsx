...
export const CardSuccess = ({ filename, filesize, onDownload }: CardSuccessProps) => {
    return (
        <div>
            <Card className='p-6 flex flex-col justify-center gap-y-6 items-center w-[600px] max-md:w-[98%] m-auto'>
                ...
                <CardContent>
                    <div className='grid justify-center'>
                        <Button className='py-2 w-56 flex gap-x-3 items-center font-semibold' onClick={onDownload}>Download
                        </Button>
                    </div>
                </CardContent>
            </Card>
